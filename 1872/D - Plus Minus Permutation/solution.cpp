...
//     int l = (x / g) * y;
 
//     int both_multiple = n / l;
 
//     int x_multiple = n / x - both_multiple;
//     int y_multiple = n / y - both_multiple;
 
//     vi ans1, ans2;
//     for(int i = n; i > n - x_multiple; i--){
//         ans1.push_back(i);
//     }
 
//     for(int i = 1; i <= y_multiple; i++){
//         ans2.push_back(i);
//     }
 
//     int sum1 = accumulate(ans1.begin(), ans1.end(), 0LL);
//     int sum2 = accumulate(ans2.begin(), ans2.end(), 0LL);
 
//     cout << sum1 - sum2;nl;
// }
 
...
 
    long long both = n / l;
 
    long long cntX = n / x - both;
    long long cntY = n / y - both;
 
    long long sum1 = cntX * (2 * n - cntX + 1) / 2;
    long long sum2 = cntY * (cntY + 1) / 2;
 
    cout << sum1 - sum2 << '
';
}
